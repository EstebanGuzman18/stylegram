...
export default function FormularioProductos() {
    ...
    return (
        <section className="relative mb-8">
            <form id="registro" className="p-8 pt-37 pb-28">
                ...
                <label for="nombre" className="self-start font-serif">Nombre del producto</label>
                ...
                <label for="precio" className="self-start font-serif">Precio</label>
                <input type="number" step="0.01" id="precio" className="border w-full rounded-lg mb-3 md:mb-5 lg:mb-6 focus:outline-none focus:ring-1 focus:ring-stylegram-primary px-2 py-1" max="99999999" required/>
            
                <label for="descripcion" className="self-start font-serif">Descripción</label>
                ...
                <label for="cantidad" className="self-start font-serif">Cantidad</label>
                <input type="number" id="cantidad" step="1" className="border w-full rounded-lg mb-3 md:mb-5 lg:mb-6 focus:outline-none focus:ring-1 focus:ring-stylegram-primary px-2 py-1" max="999999" required/>    
