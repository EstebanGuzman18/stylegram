...
CREATE TABLE IF NOT EXISTS `stylegram_db`.`clientes` (
  ...
  `correo_electronico` VARCHAR(40) NOT NULL COMMENT 'Correo electrónico \ndel cliente ',
  `contraseña` VARCHAR(20) NOT NULL COMMENT 'Contraseña con la \ncual iniciara sesión ',
...
CREATE TABLE IF NOT EXISTS `stylegram_db`.`salones_virtuales` (
  ...
  `correo_electronico` VARCHAR(40) NOT NULL COMMENT 'Correo electrónico del estilista',
  `contraseña` VARCHAR(20) NOT NULL COMMENT 'Contraseña con la cual iniciara sesión',
